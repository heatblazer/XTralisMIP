...
namespace XTralisIntegration.Background
{
    /// <summary>
    ...
    /// </summary>
    public class XTralisIntegrationBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return XTralisIntegrationDefinition.XTralisIntegrationBackgroundPlugin; }
        }
        ...
        {
            get { return "XTralisIntegration BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "XTralisIntegration Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "XTralisIntegration background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "XTralisIntegration background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}

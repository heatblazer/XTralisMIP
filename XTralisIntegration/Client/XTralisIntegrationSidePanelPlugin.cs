...
namespace XTralisIntegration.Client
{
    ...
    /// </summary>
    public class XTralisIntegrationSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new XTralisIntegrationSidePanelUserControl();
        //}
        ...
        {
            return new XTralisIntegrationSidePanelWpfUserControl();
        }
        ...
        {
            get { return XTralisIntegrationDefinition.XTralisIntegrationSidePanel; }
        }
        ...
        {
            get { return "XTralisIntegration Side panel"; }
        }

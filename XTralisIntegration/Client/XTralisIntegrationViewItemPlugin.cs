...
namespace XTralisIntegration.Client
{
    ...
    /// </summary>
    public class XTralisIntegrationViewItemPlugin : ViewItemPlugin
    {

        public XTralisIntegrationViewItemPlugin()
        {
        }
        ...
        {
            get { return XTralisIntegrationDefinition.XTralisIntegrationViewItemPlugin; }
        }
        ...
        {
            return new XTralisIntegrationViewItemManager();
        }

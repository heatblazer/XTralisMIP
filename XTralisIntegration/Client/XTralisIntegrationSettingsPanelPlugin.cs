...
{
    public class XTralisIntegrationSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return XTralisIntegrationDefinition.XTralisIntegrationSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "XTralisIntegration"; } }
        ...
        {
            _userControl = new XTralisIntegrationSettingsPanelControl(this);
            return _userControl;
        }

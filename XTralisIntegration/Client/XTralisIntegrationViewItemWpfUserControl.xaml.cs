...
namespace XTralisIntegration.Client
{
    ...
    /// </summary>
    public partial class XTralisIntegrationViewItemWpfUserControl : ViewItemWpfUserControl
    {
        #region Component private class variables

        private XTralisIntegrationViewItemManager _viewItemManager;
        ...
        /// <summary>
		/// Constructs a XTralisIntegrationViewItemUserControl instance
        /// </summary>
		public XTralisIntegrationViewItemWpfUserControl(XTralisIntegrationViewItemManager viewItemManager)
        {

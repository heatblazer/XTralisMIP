...
namespace XTralisIntegration.Client
{
    ...
    /// </summary>
    public class XTralisIntegrationViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public XTralisIntegrationViewItemManager() : base("XTralisIntegrationViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(XTralisIntegrationDefinition.XTralisIntegrationPluginId, null, XTralisIntegrationDefinition.XTralisIntegrationKind);
        ...
        //{
        //	return new XTralisIntegrationViewItemUserControl(this);
        //}
        ...
        {
            return new XTralisIntegrationViewItemWpfUserControl(this);
        }
        ...
        //{
        //	return new XTralisIntegrationPropertiesUserControl(this);
        //}
        ...
        {
            return new XTralisIntegrationPropertiesWpfUserControl(this);
        }

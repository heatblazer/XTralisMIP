...
{
    public class XTralisIntegrationWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return XTralisIntegrationDefinition.XTralisIntegrationWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(1, new XTralisIntegrationWorkSpaceViewItemPlugin(), new Dictionary<string, string>());

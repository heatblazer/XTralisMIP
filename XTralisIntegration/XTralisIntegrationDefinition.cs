...
using XTralisIntegration.Admin;
using XTralisIntegration.Background;
using XTralisIntegration.Client;
using VideoOS.Platform;
using VideoOS.Platform.Admin;
using VideoOS.Platform.Background;
using VideoOS.Platform.Client;

namespace XTralisIntegration
{
    /// <summary>
    ...
    /// </summary>
    public class XTralisIntegrationDefinition : PluginDefinition
    {
        private static System.Drawing.Image _treeNodeImage;
        private static System.Drawing.Image _topTreeNodeImage;

        internal static Guid XTralisIntegrationPluginId = new Guid("770dc423-c6d6-4451-8db3-227e85ae5549");
        internal static Guid XTralisIntegrationKind = new Guid("16912c17-dfde-46af-9a36-120a3b8e5461");
        internal static Guid XTralisIntegrationSidePanel = new Guid("88f7224b-b3c0-47c1-84d7-67b2dbf048d2");
        internal static Guid XTralisIntegrationViewItemPlugin = new Guid("5d7637d5-b323-41b2-8c8f-fafb4034a47a");
        internal static Guid XTralisIntegrationSettingsPanel = new Guid("d320085f-809f-419c-a203-02583d997371");
        internal static Guid XTralisIntegrationBackgroundPlugin = new Guid("2be764c3-af2b-4e16-bfb0-46df70316d59");
        internal static Guid XTralisIntegrationWorkSpacePluginId = new Guid("74a2ee54-5898-416b-8869-98c79e7467fa");
        internal static Guid XTralisIntegrationWorkSpaceViewItemPluginId = new Guid("09055beb-7056-476f-9ca7-5b9bb2aaa783");
        internal static Guid XTralisIntegrationTabPluginId = new Guid("6f962332-dad4-4772-be7b-d952b72aa6ca");
        internal static Guid XTralisIntegrationViewLayoutId = new Guid("5f8ac889-7623-4d34-af6c-ce69fbab9109");
        ...
        internal static Guid XTralisIntegrationWorkSpaceToolbarPluginId = new Guid("22222222-2222-2222-2222-222222222222");
        internal static Guid XTralisIntegrationViewItemToolbarPluginId = new Guid("33333333-3333-3333-3333-333333333333");
        internal static Guid XTralisIntegrationToolsOptionDialogPluginId = new Guid("44444444-4444-4444-4444-444444444444");
        ...
        /// Load resources 
        /// </summary>
        static XTralisIntegrationDefinition()
        {
        ...
        public override void Init()
        {
            ...
            _itemNodes.Add(new ItemNode(XTralisIntegrationKind, Guid.Empty,
                                         "XTralisIntegration", _treeNodeImage,
                                         "XTralisIntegrations", _treeNodeImage,
                                         Category.Text, true,
                                         ItemsAllowed.Many,
                                         new XTralisIntegrationItemManager(XTralisIntegrationKind),
                                         null
                                         ));
            if (EnvironmentManager.Instance.EnvironmentType == EnvironmentType.SmartClient)
            {
                _workSpacePlugins.Add(new XTralisIntegrationWorkSpacePlugin());
                _sidePanelPlugins.Add(new XTralisIntegrationSidePanelPlugin());
                _viewItemPlugins.Add(new XTralisIntegrationViewItemPlugin());
                _viewItemPlugins.Add(new XTralisIntegrationWorkSpaceViewItemPlugin());
                _viewItemToolbarPlugins.Add(new XTralisIntegrationViewItemToolbarPlugin());
                _workSpaceToolbarPlugins.Add(new XTralisIntegrationWorkSpaceToolbarPlugin());
                _viewLayouts.Add(new XTralisIntegrationViewLayout());
                _settingsPanelPlugins.Add(new XTralisIntegrationSettingsPanelPlugin());
            }
            if (EnvironmentManager.Instance.EnvironmentType == EnvironmentType.Administration)
            {
                _tabPlugins.Add(new XTralisIntegrationTabPlugin());
                _toolsOptionsDialogPlugins.Add(new XTralisIntegrationToolsOptionDialogPlugin());
            }

            _backgroundPlugins.Add(new XTralisIntegrationBackgroundPlugin());
        }
        ...
        public override Guid Id
        {
            get
            {
                return XTralisIntegrationPluginId;
            }
        }

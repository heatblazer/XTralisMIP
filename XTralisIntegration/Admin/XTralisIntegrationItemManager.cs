...
namespace XTralisIntegration.Admin
{
    ...
    /// </summary>
    public class XTralisIntegrationItemManager : ItemManager
    {
        private XTralisInegrationUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public XTralisIntegrationItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new XTralisInegrationUserControl();
        ...
        {
            return new XTralisIntegrationAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(XTralisIntegrationDefinition.XTralisIntegrationPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((XTralisIntegrationAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(XTralisIntegrationDefinition.XTralisIntegrationPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(XTralisIntegrationDefinition.XTralisIntegrationPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(XTralisIntegrationDefinition.XTralisIntegrationPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(XTralisIntegrationDefinition.XTralisIntegrationPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(XTralisIntegrationDefinition.XTralisIntegrationPluginId, _kind, fqid.ObjectId);
            return item;
        }
